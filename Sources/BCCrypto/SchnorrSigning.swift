...
public extension Crypto {
    static func schnorrSign<D1, D2, D3, T>(ecdsaPrivateKey: D1, message: D2, tag: D3, rng: inout T) -> Data
    ...
    static func schnorrVerify<D1, D2, D3, D4>(schnorrPublicKey: D1, signature: D2, message: D3, tag: D4) -> Bool
