...
public func aeadChaCha20Poly1305Encrypt<D1, D2, D3, D4>(plaintext: D1, key: D2, nonce: D3, aad: D4) throws -> (ciphertext: Data, auth: Data)
...
public func aeadChaCha20Poly1305Encrypt<D1, D2, D3>(plaintext: D1, key: D2, nonce: D3) throws -> (ciphertext: Data, auth: Data)
...
public func aeadChaCha20Poly1305Decrypt<D1, D2, D3, D4, D5>(ciphertext: D1, key: D2, nonce: D3, aad: D4, auth: D5) throws -> Data
...
public func aeadChaCha20Poly1305Decrypt<D1, D2, D3, D4>(ciphertext: D1, key: D2, nonce: D3, auth: D4) throws -> Data
