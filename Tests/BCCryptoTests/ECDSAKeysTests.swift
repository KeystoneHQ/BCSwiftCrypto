...
final class ECDSAKeysTests: XCTestCase {
    func testECDSAKeys() {
        ...
        let publicKey = Crypto.ecdsaPublicKeyFromPrivateKey(privateKey: privateKey)
        XCTAssertEqual(publicKey, ‡"0271b92b6212a79b9215f1d24efb9e6294a1bedc95b6c8cf187cb94771ca02626b")
        
        let decompressed = Crypto.ecdsaDecompressPublicKey(compressedPublicKey: publicKey)
        ...
        let compressed = Crypto.ecdsaCompressPublicKey(uncompressedPublicKey: decompressed)
        XCTAssertEqual(compressed, publicKey)
        
        let xOnly = Crypto.schnorrPublicKeyFromPrivateKey(privateKey: privateKey)
        XCTAssertEqual(xOnly, ‡"71b92b6212a79b9215f1d24efb9e6294a1bedc95b6c8cf187cb94771ca02626b")
        
        let derivedPrivateKey = Crypto.ecdsaDerivePrivateKey(keyMaterial: "password".utf8Data)
